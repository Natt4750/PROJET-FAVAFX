...
public class DBUtilitaires {
		...
		private static final String connStr="jdbc:mysql://ics4userver.tfs.ca:3306/nasser?useSSL=false&allowPublicKeyRetrieval=true";
		...
		public static void dbConnect() throws SQLException,ClassNotFoundException
		{
			...
			try {
				...
				connection=DriverManager.getConnection(connStr, "nasser", "Olivecard66!");
			}
